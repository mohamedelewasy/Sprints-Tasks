...
import { Iproduct, getFeaturedReq, getFeaturedRes } from "../../types/api";

const handleFeaturedProducts = (products: [Iproduct]) => {
        ...
        <div class="product-item bg-light mb-4">
          ...
          <div class="text-center py-4">
            ...
            <div class="d-flex align-items-center justify-content-center mt-2">
              <h5>$${(prod.price - prod.price * prod.discount).toFixed(2)}</h5>
...
try {
  const res = await fetchData<getFeaturedReq, getFeaturedRes>({
    url: env.API + endpoints.getFeaturedProducts.url,
    method: endpoints.getFeaturedProducts.method,
    body: undefined,
  });
  handleFeaturedProducts(res.data);
} catch (error) {
